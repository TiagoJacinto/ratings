...
function DialogContent({ children, className, scrollable, ...props }: DialogContentProps) {
  return (
    <DialogPortal data-slot='dialog-portal'>
      <DialogOverlay className={cn(scrollable && 'grid place-items-center py-4')}>
        <DialogPrimitive.Content
          ...
          className={cn(
            ...
            !scrollable && 'fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]',
            className,
          )}
          {...props}
        >
